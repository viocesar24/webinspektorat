...
<body>
        ...
        <div class="row">
                ...
                <div class="offcanvas-md offcanvas-end bg-body-tertiary" tabindex="-1" id="sidebarMenu" aria-labelledby="sidebarMenuLabel">
                    ...
                    <div class="offcanvas-body d-md-flex flex-column p-0 pt-lg-3 overflow-y-auto">
                        <ul class="nav flex-column">
                            ...
                            <li class="nav-item">
                                <a class="nav-link d-flex align-items-center gap-2 active" aria-current="page" href="<?php echo base_url(); ?>/admin-lainnya/kontak">
                                    <svg class="bi">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
                    <h1 class="h2">Dashboard Kontak</h1>
                </div>
                ...
                <div class="bg-body bg-gradient">
                    <div class="card bg-body bg-gradient shadow">
                        <div class="card-header text-center">
                            <h5 class="fw-bold p-0 m-0 text-primary">KONTAK</h5>
                        </div>
                        <div class="card-body">
                            <div class="row">
                                    ...
                                    <div class="modal fade modal-xl" id="tambahModal" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                <form id="tambahForm" action="<?php echo base_url(); ?>/admin-lainnya/kontak/create" method="post" enctype="multipart/form-data">
                                                    <div class="modal-header">
                                                        <h5 class="modal-title text-primary" id="staticBackdropLabel">FORM TAMBAH KONTAK</h5>
                                                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                                    </div>
                                                    <div class="modal-body">
                                                        <?= csrf_field() ?>
                                                        <div class="form-floating mb-3">
                                                            <input type="text" id="alamat" name="alamat" class="form-control my-1" placeholder="Alamat" value="<?= old('alamat') ?>" required>
                                                            <label for="alamat">ALAMAT</label>
                                                        </div>
                                                        <div class="form-floating mb-3">
                                                            <div class="input-group">
                                                                <input type="text" id="googlemaps" name="googlemaps" class="form-control" placeholder="Titik Google Maps" aria-label="Titik Google Maps" aria-describedby="button-addgooglemaps" value="<?= old('googlemaps') ?>" required>
                                                                <button class="btn btn-outline-secondary" type="button" id="button-addgooglemaps" data-bs-toggle="popover" title="Cara Input Google Maps" data-bs-content="Masukkan URL yang didapat dari fungsi embed Google Maps">Pentunjuk</button>
                                                            </div>
                                                        </div>
                                                        <div class="form-floating mb-3">
                                                            <input type="text" id="telepon" name="telepon" class="form-control my-1" placeholder="Telepon" value="<?= old('telepon') ?>" required>
                                            ...
                                            <div class="card bg-body bg-gradient shadow my-3">
                                                    ...
                                                    <div class="table-responsive-xxl">
                                                        <table class="table table-bordered table-striped table-hover">
                                                            <tbody>
                                                                ...
                                                                <tr>
                                                                    <th scope="row">TITIK GOOGLE MAP</th>
                                                                    <td class="text-break"><?= esc($item['googlemaps']) ?></td>
                                                                </tr>
                                                                <tr>
                                                ...
                                                <div class="card-footer">
                                                    <div class="d-grid gap-2">
                                                        ...
                                                        <form action="/admin-lainnya/kontak/delete/<?= $item['id'] ?>" method="post" class="d-grid d-inline">
                                                            <?= csrf_field() ?>
                                                    ...
                                                    <div class="modal fade modal-xl" id="ubahModal_<?= esc($item['id']) ?>" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                                                        <div class="modal-dialog">
                                                            <div class="modal-content">
                                                                <form id="ubahForm" action="<?= base_url('/admin-lainnya/kontak/update/' . $item['id']) ?>" method="post" enctype="multipart/form-data">
                                                                    <div class="modal-header">
                                                                        <h5 class="modal-title text-primary" id="staticBackdropLabel">FORM UBAH KONTAK</h5>
                                                                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                                                    </div>
                                                                    <div class="modal-body">
                                                                        <?= csrf_field() ?>
                                                                        <div class="form-floating mb-3">
                                                                            <input type="text" id="alamatEdit" name="alamat" class="form-control my-1" placeholder="Alamat" value="<?= old('alamat', $item['alamat']) ?>" required>
                                                                            <label for="alamatEdit">ALAMAT</label>
                                                                        </div>
                                                                        <div class="form-floating mb-3">
                                                                            <div class="input-group mb-3">
                                                                                <input type="text" id="googlemapsEdit" class="form-control" placeholder="Titik Google Maps" aria-label="Titik Google Maps" value="<?= old('googlemaps', $item['googlemaps']) ?>" aria-describedby="button-addon2" required>
                                                                                <button class="btn btn-outline-secondary" type="button" id="button-addon2" data-bs-toggle="popover" title="Cara Input Google Maps" data-bs-content="Masukkan URL yang didapat dari fungsi embed Google Maps">Pentunjuk</button>
                                                                            </div>
                                                                        </div>
                                                                        <div class="form-floating mb-3">
                                                                            <input type="text" id="teleponEdit" name="telepon" class="form-control my-1" placeholder="Telepon" value="<?= old('telepon', $item['telepon']) ?>" required>
    ...
    <!-- JavaScript untuk inisialisasi popover -->
    <script>
