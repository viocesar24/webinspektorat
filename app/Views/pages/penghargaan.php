<div class="d-flex bd-highlight bg-secondary bg-gradient bg-opacity-10 px-3">
    <div class="p-2 bd-highlight">
        <h2 class="text-dark p-0 m-0">PENGHARGAAN</h2>
    </div>
        ...
        <div class="col-md-3">
            <div class="card shadow">
                ...
                <div class="list-group list-group-flush">
                    <a href="<?php echo base_url(); ?>/home/view/tentang" class="list-group-item list-group-item-action">
                        Tentang
                    </a>
                    ...
                    <a href="<?php echo base_url(); ?>/home/view/penghargaan" class="list-group-item list-group-item-action active" aria-current="page">
                        Penghargaan
                    </a>
                </div>
            </div>
        ...
        <div class="col-md-9">
            <div class="card shadow">
                <div class="card-header text-center">
                    <h5 class="fw-bold p-0 m-0">PENGHARGAAN</h5>
                </div>
                <div class="card-body">
