        ...
        <div class="row">
                ...
                <div class="offcanvas-md offcanvas-end bg-body-tertiary" tabindex="-1" id="sidebarMenu" aria-labelledby="sidebarMenuLabel">
                    ...
                    <div class="offcanvas-body d-md-flex flex-column p-0 pt-lg-3 overflow-y-auto">
                        <ul class="nav flex-column">
                            <li class="nav-item">
                                <a class="nav-link d-flex align-items-center gap-2 active" aria-current="page" href="<?php echo base_url(); ?>/home/view/adminberita">
                                    <svg class="bi">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
                    <h1 class="h2">Dashboard Berita</h1>
                ...
                <!-- <div class="d-flex bd-highlight bg-body bg-gradient bg-opacity-10 px-3">
                    <div class="p-2 bd-highlight">
                        <h2 class="text-body p-0 m-0">ADMIN BERITA</h2>
                    </div>
                    <div class="ms-auto p-2 bd-highlight align-self-center d-none d-md-block">
                        <nav class="text-decoration-none pull" style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
                            <ol class="breadcrumb p-0 m-0">
                                ...
                                <li class="breadcrumb-item"><a class="link-dark text-body text-decoration-none" href="<?php echo base_url(); ?>/home/view/adminkegiatan">Admin Kegiatan</a></li>
                            </ol>
                        </nav>
                    </div>
                </div> -->
                                                    ...
                                                    <table class="table table-bordered table-striped table-hover">
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <div contenteditable="false"><?= $news_item['badan'] ?></div>
                                                                </td>
                                                            </tr>
                                                            <tr>
