                            ...
                            <li class="nav-item">
                                ...
                                <div class="collapse" id="profilSubMenu">
                                    <ul class="nav flex-column ms-3">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link active" aria-current="page" href="<?php echo base_url(); ?>/admin-profil/struktur">Struktur Organisasi</a>
                                        </li>
                                        <li class="nav-item">
                                                ...
                                                <?php foreach ($struktur as $item) : ?>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            <form action="/admin-profil/struktur/delete/<?= $item['id'] ?>" method="post" class="d-inline">
                                                                <?= csrf_field() ?>
                                                    ...
                                                    <div class="modal fade" id="editModal<?= $item['id'] ?>" tabindex="-1" aria-labelledby="editModalLabel" aria-hidden="true">
                                                        <div class="modal-dialog">
                                                            <div class="modal-content">
                                                                ...
                                                                <form action="/admin-profil/struktur/edit/<?= $item['id'] ?>" method="post" enctype="multipart/form-data">
                                                                    <?= csrf_field() ?>
                            ...
                            <div class="modal fade modal-xl" id="tambahModal" tabindex="-1" aria-labelledby="staticbackdropLabel" aria-hidden="true">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <form action="/admin-profil/struktur/create" method="post" enctype="multipart/form-data">
                                            <?= csrf_field() ?>
                                            <div class="modal-body">
                                                <div class="mb-3">
                                                    <label for="gambar" class="form-label">Gambar</label>
