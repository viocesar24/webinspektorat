    ...
    <div class="container-fluid">
        <div class="row">
                ...
                <div class="offcanvas-md offcanvas-end bg-body-tertiary" tabindex="-1" id="sidebarMenu" aria-labelledby="sidebarMenuLabel">
                    ...
                    <div class="offcanvas-body d-md-flex flex-column p-0 pt-lg-3 overflow-y-auto">
                        <ul class="nav flex-column">
                            ...
                            <li class="nav-item">
                                <a class="nav-link d-flex align-items-center gap-2 active" href="<?php echo base_url(); ?>/home/view/adminkegiatan">
                                    <svg class="bi">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                ...
                <!-- <div class="d-flex bd-highlight bg-body bg-gradient bg-opacity-10 px-3">
                    <div class="p-2 bd-highlight">
                        <h2 class="text-body p-0 m-0">ADMIN KEGIATAN</h2>
                    </div>
                    <div class="ms-auto p-2 bd-highlight align-self-center d-none d-md-block">
                        <nav class="text-decoration-none pull" style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
                            <ol class="breadcrumb p-0 m-0">
                                <li class="breadcrumb-item"><a class="link-dark text-body text-decoration-none" href="<?php echo base_url(); ?>">Beranda</a></li>
                                ...
                                <li class="breadcrumb-item"><a class="link-dark text-body text-decoration-none" href="<?php echo base_url(); ?>/home/view/adminberita">Admin Berita</a></li>
                            </ol>
                        </nav>
                    </div>
                </div> -->
                                                    ...
                                                    <div class="modal-dialog">
                                                        <div class="modal-content">
                                                            ...
                                                            <form action="<?php echo base_url(); ?>/home/hapuskegiatan" method="post">
                                                                <div class="modal-header">
                                                                    <h5 class="modal-title text-primary" id="staticBackdropLabel">Peringatan!</h5>
                                                                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                                                </div>
                                                                <div class="modal-body">
