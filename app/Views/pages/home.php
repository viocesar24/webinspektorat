                    ...
                    <div class="card h-100 shadow">
                        <div id="<?= esc($news_item['slug']) ?>" class="carousel slide" data-bs-ride="carousel">
                            ...
                            <div class="carousel-inner ratio ratio-21x9">
                                ...
                                <?php if ($news_item['gambar_4'] != '' || $news_item['gambar_4'] != null) { ?>
                                    <div class="carousel-item">
                                        <img src="/uploads/berita/<?= $news_item['gambar_4'] ?>" class="mx-auto d-block" style="height: 100%; width: 100%; object-fit: contain" alt="..." />
                                    </div>
                                <?php } ?>
                                <?php if ($news_item['gambar_5'] != '' || $news_item['gambar_5'] != null) { ?>
                                    <div class="carousel-item">
                                        <img src="/uploads/berita/<?= $news_item['gambar_5'] ?>" class="mx-auto d-block" style="height: 100%; width: 100%; object-fit: contain" alt="..." />
                                    </div>
                                <?php } ?>
                                <?php if ($news_item['gambar_6'] != '' || $news_item['gambar_6'] != null) { ?>
                                    <div class="carousel-item">
                                        <img src="/uploads/berita/<?= $news_item['gambar_6'] ?>" class="mx-auto d-block" style="height: 100%; width: 100%; object-fit: contain" alt="..." />
                                    </div>
                                <?php } ?>
                                <?php if ($news_item['gambar_7'] != '' || $news_item['gambar_7'] != null) { ?>
                                    <div class="carousel-item">
                                        <img src="/uploads/berita/<?= $news_item['gambar_7'] ?>" class="mx-auto d-block" style="height: 100%; width: 100%; object-fit: contain" alt="..." />
                                    </div>
                                <?php } ?>
                                <?php if ($news_item['gambar_8'] != '' || $news_item['gambar_8'] != null) { ?>
                                    <div class="carousel-item">
                                        <img src="/uploads/berita/<?= $news_item['gambar_8'] ?>" class="mx-auto d-block" style="height: 100%; width: 100%; object-fit: contain" alt="..." />
                                    </div>
                                <?php } ?>
                                <?php if ($news_item['gambar_9'] != '' || $news_item['gambar_9'] != null) { ?>
                                    <div class="carousel-item">
                                        <img src="/uploads/berita/<?= $news_item['gambar_9'] ?>" class="mx-auto d-block" style="height: 100%; width: 100%; object-fit: contain" alt="..." />
                                    </div>
                                <?php } ?>
                                <?php if ($news_item['gambar_10'] != '' || $news_item['gambar_10'] != null) { ?>
                                    <div class="carousel-item">
                                        <img src="/uploads/berita/<?= $news_item['gambar_10'] ?>" class="mx-auto d-block" style="height: 100%; width: 100%; object-fit: contain" alt="..." />
                                    </div>
                                <?php } ?>
                                <?php if ($news_item['gambar_11'] != '' || $news_item['gambar_11'] != null) { ?>
                                    <div class="carousel-item">
                                        <img src="/uploads/berita/<?= $news_item['gambar_11'] ?>" class="mx-auto d-block" style="height: 100%; width: 100%; object-fit: contain" alt="..." />
                                    </div>
                                <?php } ?>
                                <?php if ($news_item['gambar_12'] != '' || $news_item['gambar_12'] != null) { ?>
                                    <div class="carousel-item">
                                        <img src="/uploads/berita/<?= $news_item['gambar_12'] ?>" class="mx-auto d-block" style="height: 100%; width: 100%; object-fit: contain" alt="..." />
                                    </div>
                                <?php } ?>
                                <?php if ($news_item['gambar_13'] != '' || $news_item['gambar_13'] != null) { ?>
                                    <div class="carousel-item">
                                        <img src="/uploads/berita/<?= $news_item['gambar_13'] ?>" class="mx-auto d-block" style="height: 100%; width: 100%; object-fit: contain" alt="..." />
                                    </div>
                                <?php } ?>
                                <?php if ($news_item['gambar_14'] != '' || $news_item['gambar_14'] != null) { ?>
                                    <div class="carousel-item">
                                        <img src="/uploads/berita/<?= $news_item['gambar_14'] ?>" class="mx-auto d-block" style="height: 100%; width: 100%; object-fit: contain" alt="..." />
                                    </div>
                                <?php } ?>
                                <?php if ($news_item['gambar_15'] != '' || $news_item['gambar_15'] != null) { ?>
                                    <div class="carousel-item">
                                        <img src="/uploads/berita/<?= $news_item['gambar_15'] ?>" class="mx-auto d-block" style="height: 100%; width: 100%; object-fit: contain" alt="..." />
                                    </div>
                                <?php } ?>
                            </div>
                    ...
                    <div class="card h-100 shadow">
                        <div id="<?= esc($kegiatan_item['slug']) ?>" class="carousel slide" data-bs-ride="carousel">
                            ...
                            <div class="carousel-inner ratio ratio-21x9">
                                ...
                                <?php if ($kegiatan_item['gambar_4'] != '' || $kegiatan_item['gambar_4'] != null) { ?>
                                    <div class="carousel-item">
                                        <img src="/uploads/kegiatan/<?= $kegiatan_item['gambar_4'] ?>" class="mx-auto d-block" style="height: 100%; width: 100%; object-fit: contain" alt="..." />
                                    </div>
                                <?php } ?>
                                <?php if ($kegiatan_item['gambar_5'] != '' || $kegiatan_item['gambar_5'] != null) { ?>
                                    <div class="carousel-item">
                                        <img src="/uploads/kegiatan/<?= $kegiatan_item['gambar_5'] ?>" class="mx-auto d-block" style="height: 100%; width: 100%; object-fit: contain" alt="..." />
                                    </div>
                                <?php } ?>
                                <?php if ($kegiatan_item['gambar_6'] != '' || $kegiatan_item['gambar_6'] != null) { ?>
                                    <div class="carousel-item">
                                        <img src="/uploads/kegiatan/<?= $kegiatan_item['gambar_6'] ?>" class="mx-auto d-block" style="height: 100%; width: 100%; object-fit: contain" alt="..." />
                                    </div>
                                <?php } ?>
                                <?php if ($kegiatan_item['gambar_7'] != '' || $kegiatan_item['gambar_7'] != null) { ?>
                                    <div class="carousel-item">
                                        <img src="/uploads/kegiatan/<?= $kegiatan_item['gambar_7'] ?>" class="mx-auto d-block" style="height: 100%; width: 100%; object-fit: contain" alt="..." />
                                    </div>
                                <?php } ?>
                                <?php if ($kegiatan_item['gambar_8'] != '' || $kegiatan_item['gambar_8'] != null) { ?>
                                    <div class="carousel-item">
                                        <img src="/uploads/kegiatan/<?= $kegiatan_item['gambar_8'] ?>" class="mx-auto d-block" style="height: 100%; width: 100%; object-fit: contain" alt="..." />
                                    </div>
                                <?php } ?>
                                <?php if ($kegiatan_item['gambar_9'] != '' || $kegiatan_item['gambar_9'] != null) { ?>
                                    <div class="carousel-item">
                                        <img src="/uploads/kegiatan/<?= $kegiatan_item['gambar_9'] ?>" class="mx-auto d-block" style="height: 100%; width: 100%; object-fit: contain" alt="..." />
                                    </div>
                                <?php } ?>
                                <?php if ($kegiatan_item['gambar_10'] != '' || $kegiatan_item['gambar_10'] != null) { ?>
                                    <div class="carousel-item">
                                        <img src="/uploads/kegiatan/<?= $kegiatan_item['gambar_10'] ?>" class="mx-auto d-block" style="height: 100%; width: 100%; object-fit: contain" alt="..." />
                                    </div>
                                <?php } ?>
                                <?php if ($kegiatan_item['gambar_11'] != '' || $kegiatan_item['gambar_11'] != null) { ?>
                                    <div class="carousel-item">
                                        <img src="/uploads/kegiatan/<?= $kegiatan_item['gambar_11'] ?>" class="mx-auto d-block" style="height: 100%; width: 100%; object-fit: contain" alt="..." />
                                    </div>
                                <?php } ?>
                                <?php if ($kegiatan_item['gambar_12'] != '' || $kegiatan_item['gambar_12'] != null) { ?>
                                    <div class="carousel-item">
                                        <img src="/uploads/kegiatan/<?= $kegiatan_item['gambar_12'] ?>" class="mx-auto d-block" style="height: 100%; width: 100%; object-fit: contain" alt="..." />
                                    </div>
                                <?php } ?>
                                <?php if ($kegiatan_item['gambar_13'] != '' || $kegiatan_item['gambar_13'] != null) { ?>
                                    <div class="carousel-item">
                                        <img src="/uploads/kegiatan/<?= $kegiatan_item['gambar_13'] ?>" class="mx-auto d-block" style="height: 100%; width: 100%; object-fit: contain" alt="..." />
                                    </div>
                                <?php } ?>
                                <?php if ($kegiatan_item['gambar_14'] != '' || $kegiatan_item['gambar_14'] != null) { ?>
                                    <div class="carousel-item">
                                        <img src="/uploads/kegiatan/<?= $kegiatan_item['gambar_14'] ?>" class="mx-auto d-block" style="height: 100%; width: 100%; object-fit: contain" alt="..." />
                                    </div>
                                <?php } ?>
                                <?php if ($kegiatan_item['gambar_15'] != '' || $kegiatan_item['gambar_15'] != null) { ?>
                                    <div class="carousel-item">
                                        <img src="/uploads/kegiatan/<?= $kegiatan_item['gambar_15'] ?>" class="mx-auto d-block" style="height: 100%; width: 100%; object-fit: contain" alt="..." />
                                    </div>
                                <?php } ?>
                            </div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="card-text" contenteditable="false">
                                <?= substr($kegiatan_item['badan'], 0, 100) ?><?php if (strlen($kegiatan_item['badan']) > 100) echo '...'; ?>
                            </div>
...
<?php endif ?>
<div class="container-fluid bg-light bg-gradient bg-opacity-10 p-5 text-dark">
    <div class="row g-3">
        <div class="col-md-4">
            <?php if (!empty($kegiatan) && is_array($kegiatan)) : ?>
                    ...
                    <?php foreach (array_slice($kegiatan, 0, 5) as $kegiatan_item) : ?>
                        <div class="container-fluid p-0 mb-3">
                            <div class="row row-cols-1">
                                ...
                                <div class="col">
                                    <a href="<?php echo base_url(); ?>/home/view/kegiatan" class="link-dark">
                                        <?= esc($kegiatan_item['judul']) ?>
                                    </a>
                                </div>
                            </div>
