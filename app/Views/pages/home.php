<div id="carouselHomeAtas" class="carousel slide carousel-fade bg-secondary bg-gradient bg-opacity-10" data-bs-ride="carousel">
    ...
    <div class="carousel-inner ratio ratio-21x9">
        <div class="carousel-item active">
            <img src="<?php echo base_url(); ?>/img/dokumentasi/materi/23-6-8/1.webp" class="mx-auto d-block" style="height: 100%; width: 100%; object-fit: contain" alt="Highlight Pertama" />
