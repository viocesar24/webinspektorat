<div class="d-flex bd-highlight bg-secondary bg-gradient bg-opacity-10 px-3">
    <div class="p-2 bd-highlight">
        <h2 class="text-dark p-0 m-0">GALERI</h2>
    </div>
        ...
        <div class="col-md-3">
            <div class="card shadow">
                ...
                <div class="list-group list-group-flush">
                    ...
                    <a href="<?php echo base_url(); ?>/home/view/galeri" class="list-group-item list-group-item-action active" aria-current="page">
                        Galeri
                    </a>
        ...
        <div class="col-md-9">
            <div class="card bg-light bg-gradient shadow">
                <div class="card-header text-center">
                    <h5 class="fw-bold p-0 m-0">GALERI</h5>
                </div>
                        ...
                        <div class="col">
                            <div class="card h-100 shadow">
                                ...
                                <div class="card-body">
                                    ...
                                    <p class="card-text">Judul gambar pertama.</p>
                                </div>
                            </div>
                        </div>
                        <div class="col">
                            <div class="card h-100 shadow">
                                ...
                                <div class="card-body">
                                    ...
                                    <p class="card-text">Judul gambar kedua.</p>
                                </div>
                            </div>
                        </div>
                        <div class="col">
                            <div class="card h-100 shadow">
                                ...
                                <div class="card-body">
                                    ...
                                    <p class="card-text">Judul gambar ketiga.</p>
                                </div>
                            </div>
                        </div>
                        <div class="col">
                            <div class="card h-100 shadow">
                                <img src="<?php echo base_url(); ?>/img/pem3.jpeg" class="img-fluid card-img-top" alt="...">
                                <div class="card-body">
                                    <h5 class="card-title">Gambar Keempat</h5>
                                    <p class="card-text">Judul gambar keempat.</p>
                                </div>
                            </div>
                        </div>
                        <div class="col">
                            <div class="card h-100 shadow">
                                <img src="<?php echo base_url(); ?>/img/pem2.jpeg" class="img-fluid card-img-top" alt="...">
                                <div class="card-body">
                                    <h5 class="card-title">Gambar Kelima</h5>
                                    <p class="card-text">Judul gambar kelima.</p>
                                </div>
                            </div>
                        </div>
                        <div class="col">
                            <div class="card h-100 shadow">
                                <img src="<?php echo base_url(); ?>/img/pem1.jpeg" class="img-fluid card-img-top" alt="...">
                                <div class="card-body">
                                    <h5 class="card-title">Gambar Keenam</h5>
                                    <p class="card-text">Judul gambar keenam.</p>
                                </div>
                            </div>
                        </div>
                    </div>
