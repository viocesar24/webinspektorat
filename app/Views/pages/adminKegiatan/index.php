                ...
                <div class="offcanvas-md offcanvas-end bg-body-tertiary" tabindex="-1" id="sidebarMenu" aria-labelledby="sidebarMenuLabel">
                    ...
                    <div class="offcanvas-body d-md-flex flex-column p-0 pt-lg-3 overflow-y-auto">
                        <ul class="nav flex-column">
                            ...
                            <li class="nav-item">
                                <a class="nav-link d-flex align-items-center gap-2 active" aria-current="page" href="<?php echo base_url(); ?>/informasi/kegiatan">
                                    <svg class="bi">
                                    ...
                                    <div class="modal fade modal-xl" id="tambahModal" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                ...
                                                <form id="tambahForm" action="<?php echo base_url(); ?>/informasi/kegiatan/create" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="card bg-body bg-gradient shadow my-3">
                                                    ...
                                                    <table class="table table-bordered table-striped table-hover">
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <?php for ($i = 1; $i <= 15; $i++) : ?>
                                                                        <?php if ($item['gambar_' . $i]) : ?>
                                                                            <img src="/uploads/kegiatan/<?= $item['gambar_' . $i] ?>" alt="Gambar <?= $i ?>" height="90">
                                                                        <?php endif; ?>
                                                                    <?php endfor; ?>
                                                                </td>
                                                            </tr>
                                            ...
                                            <div class="card-footer">
                                                <div class="d-grid gap-2">
                                                    ...
                                                    <a href="/informasi/kegiatan/delete/<?= esc($item['id']) ?>" class="btn btn-danger btn-sm my-1" onclick="return confirm('Apakah Anda yakin ingin menghapus?')">HAPUS</a>
                                                </div>
                                                <!-- Modal Ubah -->
                                                <div class="modal fade modal-xl" id="ubahModal_<?= esc($item['id']) ?>" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                                                    <div class="modal-dialog">
                                                        <div class="modal-content">
                                                            <?= session()->getFlashdata('error') ?>
                                                            <?= service('validation')->listErrors() ?>
                                                            <form id="ubahForm" action="<?= base_url('/informasi/kegiatan/update/' . $item['id']) ?>" method="post" enctype="multipart/form-data">
                                                                <div class="modal-header">
