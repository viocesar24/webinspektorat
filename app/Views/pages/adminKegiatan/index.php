                ...
                <div class="offcanvas-md offcanvas-end bg-body-tertiary" tabindex="-1" id="sidebarMenu" aria-labelledby="sidebarMenuLabel">
                    ...
                    <div class="offcanvas-body d-md-flex flex-column p-0 pt-lg-3 overflow-y-auto">
                        <ul class="nav flex-column">
                            ...
                            <li class="nav-item">
                                <a class="nav-link d-flex align-items-center gap-2 active" aria-current="page" href="<?php echo base_url(); ?>/admin-informasi/kegiatan">
                                    <svg class="bi">
                                        ...
                                        <div class="card bg-body bg-gradient shadow my-3">
                                            ...
                                            <div class="card-footer">
                                                <div class="d-grid gap-2">
                                                    ...
                                                    <form action="/admin-informasi/kegiatan/delete/<?= $item['id'] ?>" method="post" class="d-grid d-inline">
                                                        <?= csrf_field() ?>
                                                ...
                                                <div class="modal fade modal-xl" id="ubahModal_<?= esc($item['id']) ?>" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                                                    <div class="modal-dialog">
                                                        <div class="modal-content">
                                                            <?= session()->getFlashdata('error') ?>
                                                            <?= service('validation')->listErrors() ?>
                                                            <form id="ubahForm" action="<?= base_url('/admin-informasi/kegiatan/update/' . $item['id']) ?>" method="post" enctype="multipart/form-data">
                                                                <div class="modal-header">
