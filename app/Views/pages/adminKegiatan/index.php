                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="table-responsive-xxl">
                                    <table id="kegiatanTable" class="table table-bordered table-striped table-hover">
                                        <thead>
                                            <tr>
                                                <th>ID</th>
                                                <th>Judul</th>
                                                ...
                                                <?php foreach ($kegiatan as $item) : ?>
                                                    <tr>
                                                        ...
                                                        <td class="text-center">
                                                            <div class="d-flex">
                                                                <a href="<?= base_url('admin-informasi/kegiatan/detail/' . $item['id']); ?>" class="btn btn-primary me-2">Detail</a>
                                                        ...
                                                        <td class="text-center">
                                                            <form id="form-switch-<?= $item['id'] ?>" action="/admin-informasi/kegiatan/active/<?= $item['id'] ?>" method="post">
                                                                <?= csrf_field() ?>
        ...
        document.querySelectorAll('.form-check-input').forEach(function(switchElement) {
            switchElement.addEventListener('change', function() {
                ...
                var confirmationMessage = isChecked ?
                    'Apakah Anda yakin ingin mengaktifkan kegiatan ini?' :
                    'Apakah Anda yakin ingin menonaktifkan kegiatan ini?';
