        ...
        <div class="col-md-3">
            <div class="card shadow">
                ...
                <div class="list-group list-group-flush">
                    <a href="<?php echo base_url(); ?>/home/view/layanan" class="list-group-item list-group-item-action">
                        Layanan
                    </a>
                    <a href="<?php echo base_url(); ?>/home/view/program" class="list-group-item list-group-item-action active" aria-current="page">
                        Program
                    </a>
                </div>
            </div>
