        ...
        <div class="card shadow">
            <div id="<?= esc($beritaDetail['slug']) ?>" class="carousel slide" data-bs-ride="carousel">
                ...
                <div class="carousel-inner ratio ratio-21x9">
                    ...
                    <?php if ($beritaDetail['gambar_4'] != '' || $beritaDetail['gambar_4'] != null) { ?>
                        <div class="carousel-item">
                            <img src="/uploads/berita/<?= $beritaDetail['gambar_4'] ?>" class="mx-auto d-block" style="height: 100%; width: 100%; object-fit: contain" alt="..." />
                        </div>
                    <?php } ?>
                    <?php if ($beritaDetail['gambar_5'] != '' || $beritaDetail['gambar_5'] != null) { ?>
                        <div class="carousel-item">
                            <img src="/uploads/berita/<?= $beritaDetail['gambar_5'] ?>" class="mx-auto d-block" style="height: 100%; width: 100%; object-fit: contain" alt="..." />
                        </div>
                    <?php } ?>
                    <?php if ($beritaDetail['gambar_6'] != '' || $beritaDetail['gambar_6'] != null) { ?>
                        <div class="carousel-item">
                            <img src="/uploads/berita/<?= $beritaDetail['gambar_6'] ?>" class="mx-auto d-block" style="height: 100%; width: 100%; object-fit: contain" alt="..." />
                        </div>
                    <?php } ?>
                    <?php if ($beritaDetail['gambar_7'] != '' || $beritaDetail['gambar_7'] != null) { ?>
                        <div class="carousel-item">
                            <img src="/uploads/berita/<?= $beritaDetail['gambar_7'] ?>" class="mx-auto d-block" style="height: 100%; width: 100%; object-fit: contain" alt="..." />
                        </div>
                    <?php } ?>
                    <?php if ($beritaDetail['gambar_8'] != '' || $beritaDetail['gambar_8'] != null) { ?>
                        <div class="carousel-item">
                            <img src="/uploads/berita/<?= $beritaDetail['gambar_8'] ?>" class="mx-auto d-block" style="height: 100%; width: 100%; object-fit: contain" alt="..." />
                        </div>
                    <?php } ?>
                    <?php if ($beritaDetail['gambar_9'] != '' || $beritaDetail['gambar_9'] != null) { ?>
                        <div class="carousel-item">
                            <img src="/uploads/berita/<?= $beritaDetail['gambar_9'] ?>" class="mx-auto d-block" style="height: 100%; width: 100%; object-fit: contain" alt="..." />
                        </div>
                    <?php } ?>
                    <?php if ($beritaDetail['gambar_10'] != '' || $beritaDetail['gambar_10'] != null) { ?>
                        <div class="carousel-item">
                            <img src="/uploads/berita/<?= $beritaDetail['gambar_10'] ?>" class="mx-auto d-block" style="height: 100%; width: 100%; object-fit: contain" alt="..." />
                        </div>
                    <?php } ?>
                    <?php if ($beritaDetail['gambar_11'] != '' || $beritaDetail['gambar_11'] != null) { ?>
                        <div class="carousel-item">
                            <img src="/uploads/berita/<?= $beritaDetail['gambar_11'] ?>" class="mx-auto d-block" style="height: 100%; width: 100%; object-fit: contain" alt="..." />
                        </div>
                    <?php } ?>
                    <?php if ($beritaDetail['gambar_12'] != '' || $beritaDetail['gambar_12'] != null) { ?>
                        <div class="carousel-item">
                            <img src="/uploads/berita/<?= $beritaDetail['gambar_12'] ?>" class="mx-auto d-block" style="height: 100%; width: 100%; object-fit: contain" alt="..." />
                        </div>
                    <?php } ?>
                    <?php if ($beritaDetail['gambar_13'] != '' || $beritaDetail['gambar_13'] != null) { ?>
                        <div class="carousel-item">
                            <img src="/uploads/berita/<?= $beritaDetail['gambar_13'] ?>" class="mx-auto d-block" style="height: 100%; width: 100%; object-fit: contain" alt="..." />
                        </div>
                    <?php } ?>
                    <?php if ($beritaDetail['gambar_14'] != '' || $beritaDetail['gambar_14'] != null) { ?>
                        <div class="carousel-item">
                            <img src="/uploads/berita/<?= $beritaDetail['gambar_14'] ?>" class="mx-auto d-block" style="height: 100%; width: 100%; object-fit: contain" alt="..." />
                        </div>
                    <?php } ?>
                    <?php if ($beritaDetail['gambar_15'] != '' || $beritaDetail['gambar_15'] != null) { ?>
                        <div class="carousel-item">
                            <img src="/uploads/berita/<?= $beritaDetail['gambar_15'] ?>" class="mx-auto d-block" style="height: 100%; width: 100%; object-fit: contain" alt="..." />
                        </div>
                    <?php } ?>
                </div>
