    ...
    <div class="ms-auto p-2 bd-highlight align-self-center d-none d-md-block">
        <nav class="text-decoration-none pull" style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
            <ol class="breadcrumb p-0 m-0">
                ...
                <li class="breadcrumb-item"><a class="text-dark text-decoration-none" href="<?php echo base_url(); ?>/home/view/KJ6PwefdEdYBam54Kegiatan">Admin Kegiatan</a></li>
            </ol>
        </nav>
    </div>
</div>
                        ...
                        <div class="card bg-light bg-gradient shadow my-3">
                            ...
                            <div class="card-body">
                                <div class="input-group my-1">
                                    ...
                                    <textarea name="judul_berita" class="form-control" placeholder="JUDUL" cols="100" rows="2" aria-label="JUDUL BERITA"><?= esc($news_item['judul']) ?></textarea>
                                </div>
                                <div class="input-group my-1">
                                    <span class="input-group-text">SLUG BERITA</span>
                                    <textarea name="slug_berita" class="form-control" placeholder="SLUG" cols="100" rows="2" aria-label="SLUG BERITA"><?= esc($news_item['slug']) ?></textarea>
                                </div>
                                <div class="input-group my-1">
                                    <span class="input-group-text">BADAN BERITA</span>
                                    <textarea name="badan_berita" class="form-control" placeholder="BADAN" cols="1000" rows="5" aria-label="BADAN BERITA"><?= esc($news_item['badan']) ?></textarea>
                                </div>
                                <div class="input-group my-1">
                                    <span class="input-group-text">WAKTU BERITA</span>
                                    <textarea name="waktu_berita" class="form-control" placeholder="WAKTU" cols="1" rows="1" aria-label="WAKTU BERITA"><?= esc($news_item['waktu']) ?></textarea>
                                </div>
                                <div class="input-group my-1">
                                    <span class="input-group-text">GAMBAR 1 BERITA</span>
                                    <textarea name="gambar1_berita" class="form-control" placeholder="LINK GAMBAR 1" cols="100" rows="2" aria-label="GAMBAR 1 BERITA"><?= esc($news_item['gambar_1']) ?></textarea>
                                </div>
                                <div class="input-group my-1">
                                    <span class="input-group-text">GAMBAR 2 BERITA</span>
                                    <textarea name="gambar2_berita" class="form-control" placeholder="LINK GAMBAR 2" cols="100" rows="2" aria-label="GAMBAR 2 BERITA"><?= esc($news_item['gambar_2']) ?></textarea>
                                </div>
                                <!-- Button trigger modal -->
