    ...
    <div class="bg-light bg-gradient p-1">
        <div class="d-flex justify-content-center text-center my-3">
            <div class="card shadow">
                ...
                <div class="card-body">
                    <a class="btn btn-primary" href="<?php echo base_url(); ?>/home/view/KJ6PwefdEdYBam54Berita" role="button">BERITA</a>
                    <a class="btn btn-primary" href="<?php echo base_url(); ?>/home/view/KJ6PwefdEdYBam54Kegiatan" role="button">KEGIATAN</a>
                </div>
            </div>
        </div>
    </div>
