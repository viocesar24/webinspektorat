        ...
        <div class="row">
                ...
                <div class="offcanvas-md offcanvas-end bg-body-tertiary" tabindex="-1" id="sidebarMenu" aria-labelledby="sidebarMenuLabel">
                    ...
                    <div class="offcanvas-body d-md-flex flex-column p-0 pt-lg-3 overflow-y-auto">
                        <ul class="nav flex-column">
                            ...
                            <li class="nav-item">
                                <a class="nav-link d-flex align-items-center gap-2 active" aria-current="page" href="<?php echo base_url(); ?>/admin-lainnya/banner-beranda">
                                    <svg class="bi">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
                    <h1 class="h2">Dashboard Banner Beranda</h1>
                </div>
                ...
                <div class="">
                    <div class="card bg-body bg-gradient shadow">
                        <div class="card-header text-center">
                            <h5 class="fw-bold p-0 m-0 text-primary">BANNER BERANDA</h5>
                        </div>
                        <div class="card-body">
                            <div class="row">
                                    ...
                                    <table class="table table-bordered table-striped table-hover">
                                        ...
                                        <tbody>
                                            <?php if (!empty($bannerBeranda)) : ?>
                                                <?php foreach ($bannerBeranda as $item) : ?>
                                                    <tr>
                                                        <td><?= $item['id'] ?></td>
                                                        <td><?= $item['judul'] ?></td>
                                                        <td><?= $item['link'] ?></td>
                                                        <td>
                                                            <img src="<?= base_url($item['gambar']) ?>" class="img-fluid" style="max-height: 100px;" alt="Responsive image">
                                                        </td>
                                                        <td>
                                                            <button class="btn btn-warning" data-bs-toggle="modal" data-bs-target="#editModal<?= $item['id'] ?>">Edit</button>
                                                            <form action="/admin-lainnya/banner-beranda/delete/<?= $item['id'] ?>" method="post" class="d-inline" onsubmit="return confirm('Apakah Anda yakin ingin menghapus banner ini?');">
                                                                <?= csrf_field() ?>
                                                        ...
                                                        <div class="modal-dialog">
                                                            <div class="modal-content">
                                                                <div class="modal-header">
                                                                    <h5 class="modal-title" id="editModalLabel">Edit Banner Beranda</h5>
                                                                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                                                </div>
                                                                <form action="/admin-lainnya/banner-beranda/update/<?= $item['id'] ?>" method="post" enctype="multipart/form-data">
                                                                    <?= csrf_field() ?>
                        ...
                        <div class="card-footer">
                            ...
                            <div class="modal fade modal-xl" id="tambahModal" tabindex="-1" aria-labelledby="staticbackdropLabel" aria-hidden="true">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title text-primary" id="staticbackdropLabel">FORM TAMBAH BANNER BERANDA</h5>
                                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                        </div>
                                        <form action="/admin-lainnya/banner-beranda/create" method="post" enctype="multipart/form-data">
                                            <?= csrf_field() ?>
                                            <div class="modal-body">
                                                <div class="mb-3">
                                                    <label for="judul" class="form-label">Judul</label>
