<div class="d-flex bd-highlight bg-secondary bg-gradient bg-opacity-10 px-3">
    <div class="p-2 bd-highlight">
        <h2 class="text-dark p-0 m-0">KEBIJAKAN</h2>
    </div>
        ...
        <div class="col-md-3">
            <div class="card shadow">
                ...
                <div class="list-group list-group-flush">
                    ...
                    <a href="<?php echo base_url(); ?>/home/view/kebijakan" class="list-group-item list-group-item-action active" aria-current="page">
                        Kebijakan
                    </a>
